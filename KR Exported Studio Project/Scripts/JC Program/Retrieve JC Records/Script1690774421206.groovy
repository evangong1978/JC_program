...
Thread.sleep(2000);
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='请选择要导出的数据'])[1]/following::span[1]")
Thread.sleep(2000);
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='取 消'])[1]/following::button[1]")
Thread.sleep(2000);
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='导出操作已生成，稍后请在 日志管理-导出文件管理中查看。'])[1]/following::button[1]")
